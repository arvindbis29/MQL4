...
input int risk_p =5;                              // Risk %
input int ii_slippage =10;                         // Slippage (in Pips)
input int ii_magicNumber =10000;                 // Magic Number
input double id_takeProfit =20;                   // Take Profit(in pips)
input double id_stopLoss = 4;                     // Stop Loss (in pips)


input string sec2 = "====== Trailling Stop Inputs Parameter ======"; //==================
input int ii_TS = 5;                              //Trailing Stop (in Pips)
input int ii_TSStart =5;                         //Trailing Stop Start (in Pips)
input int ii_TSStep = 2;                           //Trailing Stop Step (in Pips)
...
//---
   ...
   if(x==0 && y==0)
     {
      ...
      if(iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0))
        {
   ...
   if((iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)<iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)<iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0)) ||(iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0)))
     {
      y=1;
