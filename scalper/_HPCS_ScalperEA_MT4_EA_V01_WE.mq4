...
input int ii_slippage = 4;                         // Slippage (in Pips)
input int ii_magicNumber = 100003;                 // Magic Number
input double id_takeProfit = 2;                   // Take Profit(in pips)
input double id_stopLoss = 1;                     // Stop Loss (in pips)
...
//---
   ...
   if(OrdersTotal()==EMPTY_VALUE)
     {

      if(iMA(NULL,1,5,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,1,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,1,8,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,1,13,0,MODE_SMMA,PRICE_CLOSE,0))
        {
   ...
   /*if((iMA(NULL,1,5,0,MODE_SMMA,PRICE_CLOSE,0)<iMA(NULL,1,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,1,8,0,MODE_SMMA,PRICE_CLOSE,0)<iMA(NULL,1,13,0,MODE_SMMA,PRICE_CLOSE,0)) ||(iMA(NULL,1,5,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,1,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,1,8,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,1,13,0,MODE_SMMA,PRICE_CLOSE,0)))
     {
      gdt_currentTime = Time[0];
