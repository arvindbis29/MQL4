...
//---
   ...
   if(x==0 && y==0)
     {
      ...
      if((iMA(NULL,0,5,0,MODE_EMA,PRICE_CLOSE,0)>iMA(NULL,0,8,0,MODE_EMA,PRICE_CLOSE,0))&& (iMA(NULL,0,5,0,MODE_EMA,PRICE_CLOSE,1)<=iMA(NULL,0,8,0,MODE_EMA,PRICE_CLOSE,1))/*&&(iRSI(NULL,0,7,PRICE_CLOSE,0)<=50)&&(iRSI(NULL,0,7,PRICE_CLOSE,0)<iRSI(NULL,0,7,PRICE_CLOSE,1))*/&&(Close[2]<Close[1]))
        {
   ...
   if(((iMA(NULL,0,5,0,MODE_EMA,PRICE_CLOSE,0)>iMA(NULL,0,8,0,MODE_EMA,PRICE_CLOSE,0))&& (iMA(NULL,0,5,0,MODE_EMA,PRICE_CLOSE,1)<=iMA(NULL,0,8,0,MODE_EMA,PRICE_CLOSE,1))&&(iRSI(NULL,0,7,PRICE_CLOSE,0)<50)&&(iRSI(NULL,0,7,PRICE_CLOSE,0)<iRSI(NULL,0,7,PRICE_CLOSE,1)))||((iMA(NULL,0,5,0,MODE_EMA,PRICE_CLOSE,0)<iMA(NULL,0,8,0,MODE_EMA,PRICE_CLOSE,0))&& (iMA(NULL,0,5,0,MODE_EMA,PRICE_CLOSE,1)>=iMA(NULL,0,8,0,MODE_EMA,PRICE_CLOSE,1))&&(iRSI(NULL,0,7,PRICE_CLOSE,0)>50)&&(iRSI(NULL,0,7,PRICE_CLOSE,0)>iRSI(NULL,0,7,PRICE_CLOSE,1))))
     {
      y=1;
