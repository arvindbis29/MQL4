...
//---
   ...
   if(x==0 && y==0)
     {
      ...
      if(((iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,1)<iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,1)&&iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)>=iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0)) || (iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,1)<iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,1)&&iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)>=iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)))&& (iRSI(NULL,0,14,PRICE_CLOSE,0)>50))
        {
   ...
   if((iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)<iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)<iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0)&&(iRSI(NULL,0,14,PRICE_CLOSE,0)>50)) ||(iMA(NULL,0,5,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)&&iMA(NULL,0,8,0,MODE_SMMA,PRICE_CLOSE,0)>iMA(NULL,0,13,0,MODE_SMMA,PRICE_CLOSE,0)&&iRSI(NULL,0,14,PRICE_CLOSE,0)<50))
     {
      y=1;
