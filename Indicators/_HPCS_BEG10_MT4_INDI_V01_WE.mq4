//+------------------------------------------------------------------+
//|                                  _HPCS_BEG10_MT4_INDI_V01_WE.mq4 |
...
//---
   if(prev_calculated == 0)
     {
      for(int i = Bars; i>0; i--)
        {
         if(iStochastic(_Symbol, _Period, 5, 3, 3,0,1, 0, i) > iStochastic(_Symbol, _Period, 5, 3, 3,0,1, 1, i))
   ...
   if(iStochastic(_Symbol, _Period, 5, 3, 3,0,1,0, 0) > iStochastic(_Symbol, _Period, 5, 3, 3,0,1,1, 1))
