//+------------------------------------------------------------------+
//|                                  _HPCS_Adva_Mt4_EA_03_V01_WE.mq4 |
...
input int ii_trailiningStop =10; // Trailing STop
input int ii_trailiningStopStart =5; // Trailing STop  Start
input int ii_trailiningStopStep  =2; // Trailing STop Step
...
void OnTick()
  {
//---
   double ld_buy = iCustom(_Symbol, _Period, "_HPCS_ FastSlowRVIs_MT4_Indi_V01_WE",0,0);
   double ld_Sell = iCustom(_Symbol, _Period, "_HPCS_ FastSlowRVIs_MT4_Indi_V01_WE",1,0);
   ...
   TrailingStop(ii_trailiningStop,ii_trailiningStopStart,ii_trailiningStopStep,ii_magicno);
  }
//+------------------------------------------------------------------+
