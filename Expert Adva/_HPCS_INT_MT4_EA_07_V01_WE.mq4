//+------------------------------------------------------------------+
//|                                   _HPCS_INT_MT4_EA_07_V01_WE.mq4 |
...
//---
   ...
   if(iBands(NULL,0,20,2,0,PRICE_LOW,MODE_UPPER,0)>= Close[0])
     {
      ...
      if(gdt_previous != Time[0])
        {
         ...
         li_ticketforsell = OrderSend(_Symbol,OP_SELL,id_lots,Ask, ii_slippage, ld_stoplossforsell, ld_takeprofitforsell, " first Order",ii_magicno, 0, clrBlue);
